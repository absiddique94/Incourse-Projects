...
<p align="center">
  ...
  <img src="http://badge-size.now.sh/https://unpkg.com/popper.js/dist/popper.min.js?compression=gzip" alt="Stable Release Size"/>
    ...
    <br />
    <a href="https://travis-ci.org/FezVrasta/popper.js/Teames" target="_blank"><img src="https://travis-ci.org/FezVrasta/popper.js.svg?Team=master" alt="Build Status"/></a>
